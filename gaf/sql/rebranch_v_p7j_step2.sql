-- ============================================================
-- ma.v_p7j_recommendation_engine -- rebranchement etape 2
-- 28 juillet 2026
-- ============================================================
-- Deuxieme et dernier point d'accroche a rebrancher : le CTE
-- "trajectory" referencait ma.v_isa_observed_scores_by_pillar (vue
-- lente, 316670 lignes/15 ans, aucun filtre annee, rebranchee etape 1
-- sur mv_p7i_risk_source deja fait). Meme requete exacte que
-- rebranch_v_p7j_recommendation_engine.sql, seul le FROM du CTE
-- trajectory change.
...
WITH trajectory AS (
    ...
    FROM ma.mv_isa_observed_scores_by_pillar p
